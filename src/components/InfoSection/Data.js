...
export const homeObjOne = {
  ...
  image: img7,
  par: "Niewiele wiem o swoim dziadku Janie, ponieważ zmarł przed moimi narodzinami. Natomiast pamiętam dobrze babcię Agnieszkę. Pownego razu babcia spojrzała w górę na wiśnię lub czereśnię i wówczas mała gałązka oderwała się z drzewa i trafiła babcię w oko. Od tamtej pory miała problem z widzeniem przez uszkodzone oko. W starym domu u babci Agnieszki była gliniana podłoga. Kiedyś babcia Agnieszka udwiedziła nas w mieszkaniu na ul. Czarnej. Była bardzo zdziwiona telewizorem i nie mogła zrozumieć, jak poruszają się w nim osoby. Nie wiem, czy to był żart z jej strony, ale w pewnym momencie zapytała: 'czy w środku są małe ludziki?'",
  imgStart: false,
  img: img1,
  alt: "Mój dziadek",
  dark: true,
