...
import img4 from "../../images/21.jpg";
...
export const homeObjOne = {
  ...
  image: img7,
  par: "Niewiele wiem o swoim dziadku Janie, ponieważ zmarł przed moimi narodzinami. Natomiast pamiętam dobrze babcię Agnieszkę. Pownego razu babcia spojrzała w górę na wiśnię lub czereśnię i wówczas mała gałązka oderwała się z drzewa i trafiła babcię w oko. Od tamtej pory miała problem z widzeniem przez uszkodzone oko. W starym domu u babci Agnieszki była gliniana podłoga. Kiedyś babcia Agnieszka udwiedziła nas w mieszkaniu na ul. Czarnej. Była bardzo zdziwiona telewizorem i nie mogła nadziwidź się, że poruszają się w nim osoby. Nie wiem, czy to był żart z jej strony, ale w pewnym momencie zapytała: 'czy w środku są małe ludziki?'",
  imgStart: false,
  img: img1,
  alt: "Mój dziadek",
  dark: true,
...
export const homeObjTwo = {
  ...
  desc: "🕯 🕯 🕯",
  cemetery: "Cmentarz Parafialny w Zakrzewie",
  grave: "Rozalia, Helena, Józef Ofiara",
  image: img5,
  par: "Babcia Helena, w przeciwieństwie do Józefa potrafiła pisać i czytać. Pamiętam naszą rozmowę z mojego wczesnego dzieciństwa na temat śmierci. Babcia powiedziała mi, że wszyscy kiedyś umrą. Częściowo zgodziłem się z nią, ale odpowiedziałem jej, że 'ja nie umrę'. Babcia miała w izbie kufer, w którym trzymała różne rzeczy, między innymi papierowe pieniądze. Zostały jej po wymianie, na której straciła, bo inaczej, dlaczego by je zatrzymała? Poprosiłem ją o kilka banknotów, z których zrobiłem wycinanki.",
  par1: "Moja babcia posiadała kołowrotek do przędzy i inne przydatne urządzenia z drewna: maselnicę do wyrobu masła i prasę do wyrobu sera białego. Oprócz kołowrotka, cały czas ich używała. Również sama piekła chleb w piecu chlebowym. Dom moich dziadków był wykonany z drewna i kryty słomą. Słyszałem, że dziadek Józef przywiózł go z innej wsi w częściach i postawił na nowo. Były w nim dwie izby z drewnianą podłogą, przedsionek, komora i strych. W czasie okupacji w większej izbie stacjonowali niemieccy żołnierze, a w mniejszej gnieźdiła się cała siedmioosobowa rodzina.",
  par2: "Dziadek mi opowiadał, że gdy zbliżał się front, podkuł swojego konia gwoździem, aby uciekający Niemcy nie zabrali go razem z wozem, widząc, że koń kuleje. Po ucieczce Niemców, dziadek gwóźdź wyjął i koń chodził normalnie. Dzięki temu fortelowi, dziadek ocalił konia bez którego nie mógłby pracować w polu.",
  imgStart: true,
  img: img2,
  alt: "Moja babcia",
  dark: true,
...
export const homeObjThree = {
  ...
  lightTextDesc: true,
  topLine: "Moja mama",
  headline: "Marianna Gierczak z d. Ofiara (1931-1987)",
  description:
  ...
  grave: "grób 23",
  image: img6,
  par: "Moja mama była osobą bardzo pogodną. Znakomicie gotowała i potrafiła przyrządzać wyroby z wieprzowiny (szynkę, kiełbasę, kaszankę, salceson itp.). Pracowała jako sprzątaczka w 'Starostwie'. Dotakowo zajmowała się praniem w pralni chemicznej, gdzie podstawowym narzędziem była 'szczota ryżowa'. Później przyjęła się do 'blaszanki', czyli fabryki kuchenek. Po pracy szyła w domu pikowane, ortalionowe kurtki na zlecenie targowych sprzedawców. Z czasem przerzuciła się na fartuszki dla gospodyń domowych i czapeczki z krochmalonego płótna dla małych dzieci, które sama sprzedawała 'pod dworcem' i 'na Korei'.",
  par1: "Ze swoim rodzonym bratem Romkiem i przyrodnim rodzeństwem Piotrkiem, Staśkiem i Jankiem była bardzo zżyta. Do swoich rodziców, a moich dziadków żywiła ogromny i należny szacunek. W dzieciństwie, które przypadło częściowo na lata wojny i okupacji hitlerowskiej, do swojego ojca mówiła 'tatuniu', a do matki 'mamuniu'. Ponieważ była jedyną dziewczyną w domu, na jej barki spadła większość prac dpmowych związanych z porządkiem i czystością. Opowiadała mi, że największą radością była 'słodka bułka', którą czasami 'tatunio' przywiózł jej z jarmaku.",
  imgStart: false,
  img: img3,
  alt: "Moja mama",
  dark: true,
...
export const homeObjFour = {
  ...
  lightTextDesc: false,
  topLine: "Mój tata",
  headline: "Józef Gierczak (1930-1996)",
  description: "Był sąsiadem zza miedzy Marianny - mojej przyszłej mamy.",
  buttonLabel: "Czytaj więcej",
  buttonLabel1: "✝⚱",
  desc: "C5/9",
  cemetery: "Cmentarz Komunalny w Radomiu",
...
//   lightTextDesc: true,
//   topLine: "Mój tata",
//   headline: "Józef Gierczak",
//   description:
//     "Urodził się w 1930 r. Był sąsiadem zza miedzy mojej przyszłej mamy.",
