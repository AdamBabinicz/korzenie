...
export const homeObjOne = {
  ...
  image: img7,
  par: "Niewiele wiem o swoim dziadku Janie, ponieważ zmarł przed moimi narodzinami. Natomiast pamiętam dobrze babcię Agnieszkę. Pownego razu babcia spojrzała w górę na wiśnię lub czereśnię i wówczas mała gałązka oderwała się z drzewa i trafiła babcię w oko. Od tamtej pory miała problem z widzeniem przez uszkodzone oko. Kiedyś babcia Agnieszka udwiedziła nas w mieszkaniu na ul. Czarnej. Była bardzo zdziwiona telewizorem i nie mogła nadziwidź się, że poruszają się w nim osoby. Nie wiem, czy to był żart z jej strony, ale w pewnym momencie zapytała: 'czy w środku są małe ludziki?'.",
  imgStart: false,
  img: img1,
  alt: "Mój dziadek",
  dark: true,
...
export const homeObjThree = {
  ...
  par1: "Ze swoim rodzonym bratem Romkiem i przyrodnim rodzeństwem Piotrkiem, Staśkiem i Jankiem była bardzo zżyta. Do swoich rodziców, a moich dziadków żywiła ogromny i należny szacunek. W dzieciństwie, które przypadło częściowo na lata wojny i okupacji hitlerowskiej, do swojego ojca mówiła 'tatuniu', a do matki 'mamuniu'. Ponieważ była jedyną dziewczyną w domu, na jej barki spadła większość prac dpmowych związanych z porządkiem i czystością. Opowiadała mi, że największą radością dla niej była 'słodka bułka', którą czasami 'tatunio' przywiózł jej z jarmaku.",
  imgStart: false,
  img: img3,
  alt: "Moja mama",
  dark: true,
